    ...
    public static class Networking
    {
        ...
        public static void ConnectToServer(Action<SocketState> toCall, string hostName, int port)
        {
            ...
            finally
            {
                ...
                if (state != null) state.OnNetworkAction(state);
            }
        ...
        private static void ConnectedCallback(IAsyncResult ar)
        {
            ...
            var newConnection = new SocketState(state.OnNetworkAction, state.TheSocket);
        ...
        /// <summary>
        ///     Begin the asynchronous process of sending data via BeginSend, using SendAndCloseCallback to finalize the send
        ///     process.
