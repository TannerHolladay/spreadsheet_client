...
namespace SpreadsheetUtilities
{
    ...
    public class DependencyGraph
    {
        ...
        public void RemoveDependency(string s, string t)
        {
            ...
            if (_dependees[s].Count > 1) _dependees[s].Remove(t); else _dependees.Remove(s);

            if (_dependents[t].Count > 1) _dependents[t].Remove(s); else _dependents.Remove(t);
        ...
        public void ReplaceDependents(string s, IEnumerable<string> newDependents)
        {
            ...
            {
                foreach (var r in new HashSet<string>(_dependees[s]))
                {
        ...
        public void ReplaceDependees(string s, IEnumerable<string> newDependees)
        {
            ...
            {
                foreach (var r in new HashSet<string>(_dependents[s]))
                {
